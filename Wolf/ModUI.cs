...
namespace Wolf
{
    public partial class ModUI : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("There Are No Items To Remove", "No Items To Remove", MessageBoxButtons.OK,
                    MessageBoxIcon.Hand);
                return;
            }

            var Result = MessageBox.Show("Are You Sure You Want To REMOVE These Files From The Mod?",
                "Confirm Removal From Mod", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("There Are No Items In The Mod!", "No Changed Files To Pack!", MessageBoxButtons.OK,
            ...
            {
                MessageBox.Show("Please Name Your Mod!", "Mod Doesn't Have A Name!", MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                return;
            }

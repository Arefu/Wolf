namespace Celtic_Guardian.Utility
{
    public class Localized_Offset
    {
            ...
            public void SetValue(Localized_Text.Language language, long value)
            {
                switch (language)
                {
                    case Localized_Text.Language.English: English = value; break;
                    case Localized_Text.Language.French: French = value; break;
                    case Localized_Text.Language.German: German = value; break;
                    case Localized_Text.Language.Italian: Italian = value; break;
                    case Localized_Text.Language.Spanish: Spanish = value; break;
